<#
.SYNOPSIS
    Restricts "Manage auditing and security log" to Administrators only on Windows Server 2025.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\STIG-ID-WN25-UR-000025.ps1
#>
...
$content = $content -replace "SeSecurityPrivilege\s*=.*", "SeSecurityPrivilege = *S-1-5-32-544"
...
Write-Host "SeSecurityPrivilege (Manage auditing and security log) restricted to Administrators only."
