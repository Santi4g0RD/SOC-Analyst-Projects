<#
.SYNOPSIS
    Restricts the "Debug programs" user right to Administrators only on Windows Server 2025.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\STIG-ID-WN25-UR-000005.ps1
#>
...
$content = $content -replace "SeDebugPrivilege\s*=.*", "SeDebugPrivilege = *S-1-5-32-544"
...
Write-Host "SeDebugPrivilege (Debug programs) restricted to Administrators only."
