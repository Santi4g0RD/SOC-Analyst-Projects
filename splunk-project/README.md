...
| [`security-onion/`](security-onion/) | Second SIEM/NSM platform (Elastic + Zeek + Suricata, no license gating) alongside Splunk | ✅ Complete |
...
A Purdue-model ICS segment — GRFICSv2 Tennessee Eastman process simulation, OpenPLC, and a ScadaBR HMI on isolated VLANs, wired the way a real Level 0–2 OT environment is.
